    ...
    <el-dialog
      ...
      <el-form ref="form" :model="rowData" label-width="80px">
        ...
        <el-form-item label="点赞">
          <el-input v-model="rowData.Like"></el-input>
        </el-form-item>
        <el-form-item label="评论">
          <el-input v-model="rowData.CommentSum"></el-input>
        </el-form-item>
        <el-form-item label="分享">
          <el-input v-model="rowData.ShareSum"></el-input>
        </el-form-item>
        <el-form-item label="图片">
          <el-input v-model="rowData.PicSum"></el-input>
        </el-form-item>
        <el-form-item label="视频">
          <el-input v-model="rowData.VideoSum"></el-input>
        </el-form-item>
        <el-form-item>
