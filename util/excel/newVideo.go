...
func getNewVideoFromData(f *excelize.File) {
	...
	l = append(l, readPlatform(f, 91, "5a169398ef2d13461ea201a4", sheet)...) // 微博

	platSum = append(platSum, readPlatformSum(f, sheet, "B2", "5a169130ef2d1345db33cdc6")) // 空间音乐
	platSum = append(platSum, readPlatformSum(f, sheet, "B2", "5a1690eeef2d1345d21327e9")) // 空间体育
	platSum = append(platSum, readPlatformSum(f, sheet, "B2", "5a16933cef2d1346121beb0c")) // 秒拍
